...
window.SITE = {
  ...
  experience: [
    {
      ...
      points: [
        ...
        'Partner and lead geographically distributed teams across the U.S. (Legal, Governance, Compliance, DDIT, P&O, AI SMEs) and Hyderabad (DEO, Engineering, Applied AI, UX, Data Science, and Architecture teams), mentoring AI Product Managers and building organizational AI product capabilities.',
        'Drive AI open-source rapid prototyping and experimentation, building reusable modular platforms that leverage new AI capabilities and accelerate enterprise AI foundations.',
        ...
        'Define the vision, roadmap, metadata, semantic models, and data strategy for products and applications, partnering across teams to solve user and business needs.',
        'Led rollout of Veeva CRM and Salesforce features from a decision-engine perspective, translating NBA and dynamic targeting logic into scalable product capability that improved data-driven HCP engagement.',
      ],
      tags: ['AI Strategy', 'Decision Engines', 'Veeva CRM', 'Salesforce', 'Platform Architecture', 'API Strategy', 'Innovation'],
    },
    {
      company: 'Amazon',
      ...
      location: 'New York',
      points: [
        'Analyze current business processes and gaps, then design, implement, and scale improvements using data-driven, technology-enabled solutions.',
        'Define key drivers, product adoption, business outcomes, KPIs, customer use cases, and full user-flow impact across Amazon platforms via PRDs and BRDs.',
        'SME for the audience-targeting product; drove roadmap execution with business, tech, and design teams.',
        'Design and develop product frameworks, product discovery, user validation, release planning, and continuous improvement processes.',
        'Built predictive models for feature recommendations, reducing risk exposure by 3% leveraging LLMs, agent frameworks, APIs, and data cloud.',
        'Led AI/ML-driven process automation, lifting efficiency and accuracy 4% across the line of business.',
        'Conduct deep analysis on historical data using statistical techniques and machine learning to uncover patterns and trends that guide future plans.',
        'Delivered product features, ETL pipelines, dashboards, and real-time reporting systems to monitor product metrics, KRIs, and ML model performance using AWS Full Stack, Bedrock, Claude (Sonnet & Haiku), Kiro, SageMaker, and AgentCore.',
      ],
    ...
    },
    {
      ...
      location: 'New York',
      points: [
        'Led cross-org teams to build product performance data, goals, A/B testing, root-cause analysis, and tracking metrics for data-driven prioritization.',
        'Partnered with Engineering, Product, Data Engineering, and Data Science to bring in the customer voice via GTM strategy and hypothesis-testing experiments that drove product adoption and growth.',
        'Defined innovative concepts and advanced enterprise metadata standards, frameworks, policies, and operating practices, championing them through senior management and cross-functional teams.',
    ...
    },
    {
      ...
      points: [
        ...
        'Built programmatic sales and marketing solutions powered by the world\'s largest deterministic commercial database.',
        'Led CDP build-out and adoption of Salesforce CDP, driving project delivery via SDLC, JIRA, and Agile/Scrum.',
        'Aggregated and transformed Salesforce data into CDP-ready customer intelligence, enabling segmentation, audience activation, and data-driven sales and marketing use cases.',
      ],
  ...
  certifications: [
    ...
    {
      title: 'AWS Base Certification',
      org: 'Amazon Web Services (AWS)',
      period: '',
      note: '',
    },
    {
      title: 'Base SAS Certified',
      org: 'SAS',
      period: '',
      note: '',
    },
