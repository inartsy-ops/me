...
window.SITE = {
  ...
  resume: {
    ...
    highlights: [
      ...
      { value: '$30M+', label: 'Revenue enabled through AI-driven targeting' },
  ...
  experience: [
    {
      ...
      location: 'USA',
      points: [
        'Lead enterprise AI transformation strategy, roadmap, and strategic priorities, aligning AI investment with long-term business goals.',
        'Own AI-powered Next Best Action, Customer Targeting, Call Planning, and Decision-Engine (Field Orchestration) capabilities within Field Insights & Analytics.',
        'Lead enterprise technology evaluations and architecture engagements with Snowflake, Palantir, Databricks, and AWS.',
        'Lead geographically distributed teams across Hyderabad and the U.S., mentoring AI product managers.',
        'Led rollout of Veeva CRM decision-engine features, translating NBA and dynamic targeting logic into scalable product capability.',
      ],
      tags: ['AI Strategy', 'Decision Engines', 'Veeva CRM', 'Platform Architecture'],
    },
    {
      company: 'Amazon',
